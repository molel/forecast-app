...
func (c *authServiceClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (UnimplementedAuthServiceServer) Login(context.Context, *LoginRequest) (*Empty, error) {
